...
@router.post("/optimize", response_model=BookingResponse, status_code=status.HTTP_201_CREATED)
def optimize_booking(booking: BookingCreate, db: Session = Depends(get_db), current_user: dict = Depends(get_current_user)):
    """
